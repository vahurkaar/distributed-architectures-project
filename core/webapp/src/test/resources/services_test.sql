...
values (1, 'zip', 'house', 'address', 'county', 'parish', 'town_county', null, 'phone', 'sms', 'mobile', 'email', 'note', 2, now(), now(), 1, 1);
insert into public.cst_address (customer, zip, house, address, county, parish, town_county, address_type, phone, sms, mobile, email, note, country, created, updated, created_by, updated_by)
values (1, 'zip 2', 'house 2', 'address 2', 'county 2', 'parish 2', 'town_county 2', null, 'phone 2', 'sms 2', 'mobile 2', 'email 2', 'note 2', 1, now(), now(), 1, 1);